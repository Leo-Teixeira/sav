    ...
    <nav class="navbar navbar-expand-md bg-dark navbar-dark">
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../page/effectuer_demande.php">Effectuer une demande</a>
          </li>
          <li class="nav-item">
...
<?php
  ...
  {
?>
<a href="../page/inscription.php" class="btn btn-outline-primary btn-lg ml-auto">Inscription</a>
<a href="../page/index.php" class="btn btn-primary btn-lg ml-2">Connexion</a>
<?php
  }
?>
      </div>
